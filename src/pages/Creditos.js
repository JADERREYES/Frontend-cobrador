              ...
              <div key={p._id} style={s.card} onClick={() => navigate(`/clientes/${p.cliente?._id}`)}>
                <div style={s.cardTop}>
                  ...
                  <div>
                    ...
                    <span style={{ ...s.badge, background: pagado ? '#0d9488' : '#f1f5f9', color: pagado ? '#fff' : '#64748b' }}>{pct.toFixed(1)} %</span>
                  </div>
                </div>
                <div style={s.progressBar}>
                  <div style={{ ...s.progressFill, width: `${pct}%`, background: pagado ? '#22c55e' : '#0d9488' }} />
                </div>
                <div style={s.meta}>
