  ...
  return (
    <div style={{ minHeight:"100vh", background:"#f1f5f9", fontFamily:"Inter,sans-serif" }}>
      <div style={{ background:"#fff", padding:"14px 16px", display:"flex", alignItems:"center", justifyContent:"space-between", borderBottom:"1px solid #e2e8f0", position:"sticky", top:0, zIndex:10, boxShadow:"0 1px 4px rgba(0,0,0,0.06)" }}>
        ...
        <button style={{ background:"#0d9488", color:"#fff", border:"none", borderRadius:"10px", padding:"9px 14px", fontWeight:"700", fontSize:"14px", cursor:"pointer", WebkitTapHighlightColor:"transparent" }} onClick={() => setShowModal(true)}>
          + Agregar
        </button>
      </div>
        ...
        >
          <div style={{ background:"#fff", borderRadius:"20px 20px 0 0", padding:"24px 16px 32px", width:"100%", maxWidth:"500px", maxHeight:"90vh", overflowY:"auto" }}>
            ...
            <div style={{ display:"flex", gap:"12px" }}>
              ...
              <button style={{ flex:1, padding:"15px", border:"none", borderRadius:"10px", background: saving?"#5eaaa4":"#0d9488", fontSize:"15px", fontWeight:"700", cursor: saving?"not-allowed":"pointer", color:"#fff" }} onClick={handleSave} disabled={saving}>{saving?"Guardando...":"Agregar Cliente"}</button>
            </div>
          </div>
        </div>
      )}
