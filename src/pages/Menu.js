...
export default function Menu({ user, onLogout }) {
  ...
  const menuItems = [
    { icon: "👥", label: "Clientes", sub: "Ver y gestionar tus clientes", path: "/clientes", bg: "#0ea5e9" },
    { icon: "💳", label: "Creditos", sub: "Ver todos los creditos activos", path: "/creditos", bg: "#10b981" },
  ];

  return (
    <div style={{ minHeight: "100vh", background: "#f1f5f9", display: "flex", flexDirection: "column" }}>
      <div style={{ background: "linear-gradient(135deg, #0d9488, #0f766e)", padding: "20px 20px 32px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <div style={{ width: "44px", height: "44px", background: "rgba(255,255,255,0.2)", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "22px" }}>
              $
            </div>
            <div>
